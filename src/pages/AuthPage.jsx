...
import { Button, Col, Form, Image, Modal, Navbar, Row } from "react-bootstrap";
        ...
        <div>
            <Navbar className="p-3" style={{ backgroundImage: "linear-gradient(to right, #fcbc77, #f5dbbf)" }}>
                ...
                <Navbar.Collapse className="justify-content-end">
                    <Button className="rounded-pill hover-icon" variant="outline-dark" style={{ backgroundColor: "#e0af79" }} onClick={handleFrontPage}
                    >
                        Back to Home
                    </Button>
                </Navbar.Collapse>
            ...
            <Row>
                ...
                <Col sm={6} className="p-4" style={{ backgroundImage: "linear-gradient(to right, #fcbc77, #f5dbbf)" }}>
                    ...
                    <p className="mt-2" style={{ fontSize: 40, fontStyle: "italic" }}>Fail to Plan, Plan to Fail!</p>
